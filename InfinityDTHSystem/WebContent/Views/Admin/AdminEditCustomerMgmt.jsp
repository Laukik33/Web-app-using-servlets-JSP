...
<form class="editUserForm"
			action="${pageContext.request.contextPath}/admin/edit/customer?id="${customerId}
			method="POST">
			...
			<div class="row">
				...
				<div class="col">
					<div class="form-group input-group-sm mb-1">
						<label for="exampleSelect1">Operator Name</label>						
						<select class="form-control" id="exampleSelect1" name="operators">
							<c:forEach var="operators" items="${operators}">
								<option value="${operators.firstName}">${operators.firstName}</option>
							</c:forEach >
						</select>
					</div>
				</div>
				...
				<div class="col">
					<div class="form-group input-group-sm mb-1">
						<label for="exampleSelect1">Retailer Name</label>			
						<select class="form-control" id="exampleSelect1" name="retailers">
							<c:forEach var="retailers" items="${retailers}">
								<option value="${retailers.retailName}">${retailers.retailName}</option>
							</c:forEach >
						</select>
					</div>
				</div>
