...
<jsp:include page="../../partials/operatorMenu.jsp" />
		<div class="tableSection">
			<table class="table text-left text-uppercase table-sm table-striped">
  ...
  <!-- <button class="btn btn-secondary btn-sm justify-content-end dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Filter
  </button>-->
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" name="dropdown">
    <a class="dropdown-item" href="#" value="getAll">All Customers</a>
    <a class="dropdown-item" href="#" value="filter">Delete Requests</a>
								...
								<div class="btn-group  dropright">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<!--  <a name="action" value="delete" class="dropdown-item"
											href="${pageContext.request.contextPath}/operator/edit/customer?id=${customer.customerId}">Delete</a>-->
										<a name="action" value="update" class="dropdown-item"
											href="${pageContext.request.contextPath}/operator/edit/customer?id=${customer.customerId}">Edit</a>
				...
				<div class="modal-dialog modal-dialog-centered modal-lg"
					...
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalCenterTitle">Create New Customer
								</h5>
						...
						<div class="modal-body">
							<form class="editUserForm" action="${pageContext.request.contextPath}/operator/customer/register" method="POST">
								<div class="row">
									<div class="col">
										<!-- FIRST NAME  -->
								...
								<div class="form-group input-group-sm mb-1">
									...
									<div class="col">
										<div class="form-group input-group-sm mb-1">
											<label for="password" class="col-form-label">Default Password: (1234)
												</label> <input type="text" class="form-control" id="password"
												name="password" value="1234" hidden>
										</div>
										<!-- LAST NAME -->
								<div class="row">
									<div class="col">
