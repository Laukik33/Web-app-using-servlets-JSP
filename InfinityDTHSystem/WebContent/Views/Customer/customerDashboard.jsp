...
<!-- HORIZONTAL NAV -->
  ...
  <form class="displayForm">
    ...
    <div class="col">
      <div class="form-group input-group-sm mb-1">
        ...
        <input type="text" class="form-control" id="last-name" value="${cust.lastName}">
      </div>
      <!-- LAST NAME --> 
    </div>
  </div>
  ...
  <div class="form-group input-group-sm mb-1">
    ...
    <input type="email" class="form-control" id="email" value="${cust.email}">
  </div>
  <!-- EMAIL -->
  <!-- PASSWORD -->
  <div class="form-group input-group-sm mb-1">
    <label for="password" class="col-form-label">Password</label>
    <input type="password" class="form-control checkValid1" name="${cust.password}" value="123" id="password"></input>
  </div>
  <!-- PASSWORD -->
  <!-- SECOND PASSWORD -->
<!--   <div class="form-group input-group-sm mb-1"> -->
    ...
    <div class="col">
     ...
     <fieldset>
      ...
      <div class="form-group input-group-sm mb-1">
        ...
        <input type="text" class="form-control" id="streetAddress1" name="streetAddress1" value="${cust.address1}">
      </div>
      <!-- END STREET ADDRESS 1 -->
      <!-- BEGIN STREET ADDRESS 2 -->
      <div class="form-group input-group-sm mb-1">
        <label for="streetAddress2" class="col-form-label">Street Address 2</label>
        <input type="text" class="form-control" id="streetAddress2" name="streetAddress2" value="${cust.address2}">
      </div>
      ...
      <div class="row">
        ...
        <div class="col">
         <div class="form-group input-group-sm mb-1">
           ...
           <input type="text" class="form-control" id="city" name="city" value="${cust.city}">
         </div>
       </div>
       <!-- END CITY -->
       <!-- BEGIN STATE -->
       <div class="col">
         <div class="form-group input-group-sm mb-1">
          ...
          <input type="text" class="form-control" id="state" name="state" value="${cust.state}">
        </div>
      </div>
    </div>
    <!-- END STATE -->
    ...
    <div class="row"> <!-- NEW ROW -->
      ...
      <div class="col">
       <div class="form-group input-group-sm mb-1">
        ...
        <input type="number" class="form-control" id="zip" name="zip" value="${cust.zip}">
      </div>
    </div>
    <!-- END ZIP -->
    <!-- BEGIN COUNTRY  -->
...
<%--       <input type="text" class="form-control" id="country" name="country" value="${cust.country}"> --%>
<!--     </div> -->
<!--   </div> -->
  <!-- END COUNTRY  -->
</div> <!-- END ROW -->
...
<!--   <button type="submit" name="action" value="Discontinue" class="btn btn-danger " >Cancel Services</button> -->
  </form>
${result}
